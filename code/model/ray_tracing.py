...
class RayTracing(nn.Module):
    def __init__(
        ...
        for board_scene_idx in range(board_num):
            ...
            print(data_dir + '/scaled_board_' + str(board_scene_idx) + '_mesh_with_texture_clip.obj')
            print(data_dir + '/board_' + str(board_scene_idx) + '_mesh_with_texture_u1_v1.png')
    ...
    def diff_mesh_ray_tracing(self,
        ...
        if use_our_corr:
            ...
            for i in range(board_indices.shape[0]):
                ...
                if board_idx < 0:
                    refract_img = torch.clamp(refract_img, 0, 0)
                    reflect_img = torch.clamp(reflect_img, 0, 0)
                    continue
